...
These three are the approved go-to images, shipped with the installed skill package — users of this standalone file: try the public repo download per Step 6, else use the labeled `[campus photo — JHH or Bayview]` placeholder:
